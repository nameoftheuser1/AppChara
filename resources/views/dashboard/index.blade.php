<x-admin-layout>
    <div class="container min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <!-- Point of Sale Card -->
            <div class="bg-white rounded-lg shadow-md p-6 cursor-pointer hover:shadow-lg transition-all duration-300" onclick="window.location='{{ route('pos.index') }}'">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-yellow-100 text-yellow-600 p-3 rounded-full">
                        <svg class="w-6 h-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            <path d="M17.876.517A1 1 0 0 0 17 0H3a1 1 0 0 0-.876.517A1 1 0 0 0 2 1.5V6h16V1.5a1 1 0 0 0-.124-.983Z" />
                            <path d="M2 7v11.5a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V7H2Zm6 8H4v-2h4v2Zm0-4H4v-2h4v2Zm6 4h-4v-2h4v2Zm0-4h-4v-2h4v2Z" />
                        </svg>
                    </div>
                </div>
            </div>
            ...
            <!-- Reservations Card -->
            <div class="bg-white rounded-lg shadow-md p-6 cursor-pointer hover:shadow-lg transition-all duration-300" onclick="window.location='{{ route('reservations.all') }}'">
                <div class="flex items-center justify-between">
                    <div>
                    ...
                    <div class="bg-green-100 text-green-600 p-3 rounded-full">
                        <svg class="w-6 h-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            <path d="M11.074 4 8.442.408A.5.5 0 0 0 8 .188a.5.5 0 0 0-.442.22L4.926 4H1.5A1.5 1.5 0 0 0 0 5.5v9A1.5 1.5 0 0 0 1.5 16h17a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 18.5 4h-7.426ZM8 13.5a3.5 3.5 0 1 1 0-7 3.5 3.5 0 0 1 0 7Z" />
                        </svg>
                    </div>
                </div>
            </div>
            ...
            <!-- Sales List Card -->
            <div class="bg-white rounded-lg shadow-md p-6 cursor-pointer hover:shadow-lg transition-all duration-300" onclick="window.location='{{ route('sales.list') }}'">
                <div class="flex items-center justify-between">
                    <div>
        ...
        <div class="max-h-56 h-2">
            <div class="bg-white rounded-lg p-6">
                ...
                <div class="space-y-4">
                    @foreach ($monthlyHistoricalData as $monthData)
