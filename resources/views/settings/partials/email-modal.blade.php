<div id="emailModal" class="fixed inset-0 bg-black/50 overflow-y-auto h-full w-full z-50 hidden">
    <div
        ...
        <div class="bg-white rounded-lg shadow-xl p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <button id="closeEmailModal" class="text-gray-600 hover:text-gray-900">
            ...
            <form method="POST" action="{{ route('admin.change-email') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email"
                        ...
                        value="{{ old('email', $currentEmail) }}" required />
                </div>
