    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Update the details of the product</p>
            </div>
            ...
            <div class="space-y-1">
                ...
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                    <div class="space-y-1 text-center">
                        <!-- Preview Area -->
                        <div id="imagePreview" class="{{ $product->img_path ? '' : 'hidden' }} mb-4">
                            <img id="preview"
                                src="{{ $product->img_path ? asset($product->img_path) : '' }}"
                                alt="Preview" class="mx-auto max-h-48 rounded-lg shadow-sm">
                        ...
                        <div id="uploadIcon" class="{{ $product->img_path ? 'hidden' : '' }}">
